...
sapply(1:20, function(chr){

  DATA<-paste0("PAWS_snps_filtered_recoded.chr",chr)
  ...
  write.table(snp_list, paste0("exclude_snp_list.chr",chr,".txt"), col.names = F, row.names= F, quote = F, sep = " ")
